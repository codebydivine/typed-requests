...
class ECommerceAPIClient:
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None):
        ...
        self.headers = {
            ...
            "User-Agent": "Divine-Requests-ECommerce-Client/1.0"
        }
    ...
    async def get_products(self, category_id: Optional[int] = None, 
    ...
    async def create_order(self, billing_address_id: int, 
...
async def product_browsing_example():
    ...
    async with ECommerceAPIClient("https://api.example-store.com") as client:
        try:
...
async def comprehensive_workflow_example():
    ...
    print(f"Shopping Session Details:")
